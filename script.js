...
$("head").append(`<script src="https://cdnjs.cloudflare.com/ajax/libs/jszip/3.10.0/jszip.min.js"></script>`)
    // $("body").attr("data-id-copy", `{"theme_id":"${$("#").split("/themes/")[1].trim()}", "store_id":"${plugooDashboardTheme.themeAssetsUrl.split("/themes/")[0].split("br/")[1].trim()}"}` )
...
// fetch("https://images.tcdn.com.br/910633/themes/47//img/settings/BlackFriday-Newsletter.png")
//     .then((response) => {
//         if (!response.ok) {
